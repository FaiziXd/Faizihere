...
<body>
  <header class="header mt-4">
    <h1>— 𝖳𝗁𝗐 Muhtaram 𝖨𝗇𝗌𝗂𝗂𝖾 - MADE BY Muhtaram BRAND 😈</h1>
    <h2>𒁍͟͟͞͞ » 𝐓ʜ'ɜ̽ 𝐔ƞ͜͡sʈɵ̊pɮɭɛ̽ 𝑤𝑖͜͡𝑐𝑘͜͡𝑒𝑑 𝐵͜͡𝑜͢𝑖𝑖 Ɱᶙ͜͡ɧʈʌɽ͜͡ʌ͢ɱ  𝐻͜͡𝑒͢𝑟𝑒 ː💔𒁍͟ 😙</h2>
  </header>
  ...
  <footer class="footer">
    <p>&copy; Developed by Tye Muhtaram Xd2024</p>
  </footer>
</body>
</html>
'''
